...
void Move_shariki (int dt2)
    ...
    CBall b_igr = {750, 400, 20, 20, 27, TX_LIGHTGREEN};
 ...
 //       Igrok (&x_igr, &y_igr, &vx_igr, &vy_igr, &dt, rad);
        ...
        if (Dist (b_Cnar1.x, b_Cnar1.y, b_igr.x, b_igr.y) <= b_Cnar1.rad + b_igr.rad ||
            ...
            Dist (b_Cnar_Bol1.x, b_Cnar_Bol1.y, b_igr.x, b_igr.y) <= b_Cnar1.rad + b_igr.rad ||
            Dist (b_Cnar_Bol2.x, b_Cnar_Bol2.y, b_igr.x, b_igr.y) <= b_Cnar1.rad + b_igr.rad )
            {
